...
export const navigationSections = [
  {
    ...
    dropdown: {
      ...
      items: [
        ...
        {
          title: "BITS Sports & Queuing (Sports360)",
          badge: "Venues & Retail",
...
export const bitsProducts = [
  ...
  {
    id: "sports-hub",
    name: "BITS Sports (Sports360-Style)",
    shortName: "Sports Venue Hub",
    category: "sports",
    ...
    description:
      "Complete sports venue and club management system inspired by Sports360. Automates court assignments, live TV queuing display boards, tournament brackets, player leaderboards, and membership passes for badminton, basketball, padel, pickleball, and tennis centers.",
    complianceBadges: [
