...
export const navigationSections = [
  {
    ...
    dropdown: {
      ...
      items: [
        ...
        {
          title: "BITS Pickleball & Court Operating System",
          badge: "Courts & Queue",
          description: "Automated paddle rack rotation, game queuing for every play, court booking & TV screens.",
        ...
        {
          title: "BITS Payroll Engine",
          badge: "Tax & Bank Feeds",
          description: "Automated TRAIN Law tax tables, SSS/PhilHealth/Pag-IBIG & direct bank batch feeds.",
          href: "/products/payroll",
          icon: "accounting" as const,
        },
        {
          title: "BITS Inventory Engine",
          badge: "Stock & Warehouse",
          description: "Multi-warehouse material allocation, par levels, lot tracking & barcode/RFID sync.",
          href: "/products/inventory",
          icon: "process" as const,
        },
        {
          title: "BITS Logistics Cloud",
          badge: "Fleet & Dispatch",
          description: "AI route optimization, real-time GPS tracking, driver mobile app & ePOD signatures.",
          href: "/products/logistics",
          icon: "process" as const,
        },
        {
          title: "BITS Booking System",
          badge: "Appointments",
          description: "Online calendar reservations, resource capacity management & deposit escrow.",
          href: "/products/booking",
          icon: "process" as const,
        },
        {
          title: "BITS Smart Queuing",
          badge: "Virtual Queue",
          description: "Overhead TV screen displays, QR ticket issuance, SMS alerts & teller window HUD.",
          href: "/products/queuing",
          icon: "pipeline" as const,
        },
        {
...
export const theDifference = [
  {
    ...
    generic: "Forces your staff to follow rigid screens and unnecessary extra steps",
    bits: "Built directly around your team's real daily tasks, roles, and call scripts",
  },
  {
    category: "Custom Fields & Data",
    generic: "Locked into fixed forms and fields that don't match your actual paperwork",
    bits: "Custom fields, tailored call outcome buttons, and automated queue routing",
  },
  {
    category: "Automations & Alerts",
    generic: "Basic email alerts that break easily and require constant manual fixes",
    bits: "Reliable built-in automations: instant reminders, auto-requeuing, and supervisor alerts",
  },
  {
    category: "AI & Customer Assistance",
    generic: "Basic robot widgets that cannot look up account balances or answer real questions",
    bits: "Smart AI voice & message assistants connected directly to customer histories and manuals",
  },
  {
    category: "Security & Control",
    generic: "Shared public servers with weak activity tracking and no data ownership",
    bits: "Strict user permissions, tamper-proof activity logs, and your choice of private or office servers",
  },
  {
    category: "Updates & Support",
    generic: "Waiting months or years for generic software companies to fix your issues",
    bits: "Direct tech support and continuous system updates tailored to your business",
  },
] as const;
...
export const bitsProducts = [
  ...
  {
    id: "pickleball",
    name: "BITS Pickleball & Court Operating System",
    shortName: "Pickleball OS",
    category: "sports",
    categoryLabel: "Sports, Booking & Queuing Cloud",
    badge: "Queues, Rotations & Booking",
    isFlagship: false,
    tagline: "Automated Paddle Rotation, Game Queuing for Every Play & Online Court Booking",
    description:
      "The dedicated court operating system for pickleball clubs, recreation facilities, and padel centers. Automates open-play paddle rack queues, rotation after every single play/game (4-on-4-off, winner stays, skill tiers), online court reservations with instant deposits, and live overhead TV queue boards that eliminate whiteboard chaos and player arguments.",
    complianceBadges: [
      "Fair Queue Rotation Engine",
      "Real-Time Overhead TV HUD",
      "Online Court Reservation & Escrow",
      "DUPR & Skill-Tier Matching",
    ],
    capabilities: [
      "Digital Paddle Rack & Fair Open-Play Rotation Queue",
      "Automated Queuing for Every Game / Play (4-On 4-Off, Winner Stays, Skill Tiers)",
      "Online Court Booking & Instant Deposit Checkout",
      "Overhead TV Screen Queue & Next-Up Voice Chime HUD",
      "Player QR Check-In, DUPR & Skill Rating Balancing",
      "Tournament Brackets, Elimination Ladders & Live Scoreboards",
    ],
    metrics: { label: "Court Utilization", value: "99.4% Active" },
    ctaText: "Explore Pickleball OS",
    ctaHref: "/products/pickleball",
  },
  {
    id: "sports-hub",
...
export const deploymentModels = [
  {
    ...
    badge: "Fast Turnkey Setup",
    tagline: "We host and manage everything for you in a secure cloud. No physical servers needed.",
    description:
      "Perfect if you want to get started fast with zero hardware to buy or maintain. We handle all hosting, daily backups, and updates.",
    idealFor: "Remote teams, fast-growing offices, and businesses wanting zero IT headaches.",
    advantages: [
      "Fast turnkey setup with zero hardware to buy or wait for",
      "No server maintenance, electricity bills, or cooling costs",
      "Automatic daily backups and built-in disaster protection",
      "Easily add more team members, phones, and calling lines anytime",
      "Crystal-clear call quality with 99.9% reliable uptime",
      "Free automatic software updates with zero interruptions to your workday",
    ],
    financialModel: {
      type: "Simple Monthly or Yearly Billing",
      setupScope: "Onboarding & Setup Included",
      setupDetails:
        "Covers guided customer data import, queue configuration, phone line setup, and supervisor/agent training.",
      ongoingScope: "Predictable Flat Platform Fee",
      ongoingDetails:
        "Transparent pricing based on active seats and minutes with cloud hosting and ongoing support included.",
    },
    specs: [
      { label: "Setup Speed", value: "Fast Turnkey Setup" },
      { label: "Hardware Needed", value: "Zero Hardware Required" },
      { label: "Data Protection", value: "Private Encrypted Cloud" },
      { label: "System Maintenance", value: "Fully Handled by BITS" },
    ],
  },
  {
    id: "on-prem",
    title: "Your Own Office Servers",
    badge: "Total Privacy & Server Control",
    tagline: "Run BITS directly on your existing office computers, servers, or private company network.",
    description:
      "Designed for banks, finance firms, and call centers that require customer records and call recordings to stay strictly inside their own building.",
    idealFor: "Companies with existing server rooms, strict privacy policies, or closed internal networks.",
    advantages: [
      "Total privacy — customer records and call audio never leave your physical office",
      "Use your existing computers and servers without buying new gear",
      "Cut long-term costs — avoid ongoing per-user cloud fees for years of savings",
      "Direct connection to your local landlines, office PBX, or SIM gateways",
      "Works completely offline inside your private office network",
      "Step-by-step guidance — our team checks your computers and sets up everything for you",
    ],
    financialModel: {
      type: "One-Time Setup with Complete Server Ownership",
      setupScope: "Full Installation & Team Training",
      setupDetails:
        "Covers server setup, system installation, phone connection, and complete training for your team.",
      ongoingScope: "Simple Yearly Support & Updates",
      ongoingDetails:
        "Optional yearly support covering software updates, security checks, and direct technical help.",
    },
    specs: [
      { label: "Setup Speed", value: "Guided White-Glove Setup" },
      { label: "Hardware Needed", value: "Use Existing Office Servers" },
      { label: "Data Protection", value: "100% Inside Your Office" },
      { label: "System Maintenance", value: "Supported by BITS Engineers" },
    ],
  },
] as const;
...
export const solutionPackages = [
  {
    ...
    tagline: "For growing teams and specialized businesses replacing disconnected spreadsheets with tailored operational software.",
    teamScope: "1 – 15 Seats",
    deployment: "Secure Managed Cloud",
    investmentModel: "Modular Entry Scoping",
    billingCadence: "Tailored to Team Scale & Operational Volume",
    pricingModel: "Modular Base Scoping",
    pricingSubtext: "Assisted data migration & team onboarding included",
    roiBenchmark: "Replaces 3–4 disconnected SaaS subscriptions & manual Excel sheets",
    highlights: [
      "Modular Procurement: Any 1 of our 18 Engines or Custom Pair",
      "Tailored Database Schemas & Operational Workflows",
      "Dynamic Task Queues & Department Kanban Stages",
      "Standard Real-Time Operations & Performance Dashboards",
      "Granular Role-Based Access Control (RBAC)",
      "Immutable System Action & Audit Trails",
      "Custom CSV/Excel Data Mapping & Legacy Migration",
      "White-Label Option: Available as Add-On (Your Logo & Domain)",
  ...
  },
  {
    ...
    tagline: "For scaling multi-team operations requiring automated workflows, communications, and supervisor control.",
    teamScope: "16 – 100+ Floor",
    deployment: "High-Availability Cloud + SIP",
    investmentModel: "Flexible Volume Licensing",
    billingCadence: "Scales with Concurrent Users & Transaction Volume",
    pricingModel: "Modular Seat & Volume",
    pricingSubtext: "Volume floor discounts & priority engineering access",
    roiBenchmark: "Cuts team operational idle time by 42% via automated workflows & HUD",
    highlights: [
      "Everything in Starter Tier",
      "Multi-Module Integration Across Departmental Silos",
      "Integrated Communications (WebRTC, SMS & Email)",
      "Automated Workflow Triggers & Event Webhooks",
      "BITSagent Autonomous AI Operations & Task Handling",
      "Real-Time Supervisor Management HUD & Telemetry",
      "Standardized Performance Metrics & Audit Logs",
      "White-Label Option: Available as Add-On (app.yourbrand.com)",
  ...
  },
  {
    ...
    tagline: "For corporations, conglomerates, banks, and organizations with complex security & multi-entity needs.",
    teamScope: "100+ / Multi-Entity",
    deployment: "Private VPC / Sovereign / On-Prem",
    investmentModel: "Sovereign Master Agreement",
    billingCadence: "Bespoke Enterprise SLA & Dedicated Tenancy",
    pricingModel: "Master Services Agreement",
    pricingSubtext: "Dedicated Solutions Architect, Custom SLA & Compliance",
    roiBenchmark: "Zero per-seat inflation penalties; complete private VPC & data residency",
    highlights: [
      "Everything in Growth Tier",
      "Full Multi-Product Operational Cockpit (All 18 Engines Supported)",
      "Fully Bespoke Database Schemas, Logic & Legacy Feeds",
      "Autonomous BITSagent Voice & Email AI Operations",
      "Private RAG Knowledge Grounding on Corporate SOPs",
      "Private Cloud VPC or Sovereign On-Premises Deployment",
      "Statutory Compliance Vaults (BIR CAS, BSP, DOLE, NPC DPA)",
      "Universal White-Label Option Included / Available for Resellers",
  ...
  {
    id: "whitelabel",
    tier: "BRANDING OPTION",
    badge: "Master Add-On · Not a Standalone Product",
    title: "Universal White-Label Branding Option",
    tagline: "Deploy any of our 18 software products under your own corporate identity, company logo, and custom domain (app.yourbrand.com).",
    teamScope: "Applicable to Any Plan",
    deployment: "Managed Cloud or Private VPC",
    investmentModel: "Turnkey Reseller / Corporate Branding License",
    billingCadence: "White-Label Setup + Wholesale Engine Infrastructure",
    pricingModel: "Master Branding License Add-On",
    pricingSubtext: "Scoped on top of any active engine tier or multi-product bundle",
    roiBenchmark: "100% brand equity ownership; resell to your own clients at 100% margin retention",
    highlights: [
      "Complete Visual Rebranding (Logo, Favicon, Color Palette, Fonts)",
      "Custom Domain & Automated SSL (e.g., app.yourcompany.com)",
      "Client-Branded Transactional Emails & SMS Gateway",
      "Complete NDA Protection — Zero BITS Attribution",
      "Full Reseller Margin Retention — Set Your Own Client Pricing",
      "Multi-Tenant Client Partitioning & Dedicated Databases",
      "Works with Any of the 18 BITS Software Engines",
    ],
    primaryCta: "Inquire About White-Label Reselling",
...
export const suiteBundlePresets = [
  {
    ...
    productIds: ["collections", "ai-agent", "rag-engine"],
  ...
  },
  {
    ...
    productIds: ["pickleball", "sports-hub", "booking", "queuing", "nfc-card"],
...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "All BITS systems can be deployed both in the cloud and on your own office servers. We recommend our Managed Cloud deployment for fast turnkey setup, automatic scaling, high reliability, and continuous security with zero IT hardware overhead. For organizations with strict internal data policies, banking compliance, or existing server infrastructure, we provide complete on-site setup and private server deployment.",
  },
  {
...
export const footerColumns = [
  ...
  },
  {
    title: "Key Engines",
    links: [
      { label: "Accounting & ERP", href: "/products/accounting" },
      { label: "HRMS Cloud", href: "/products/hrms" },
      { label: "Payroll Compliance Core", href: "/products/payroll" },
      { label: "Construction & Jobsite", href: "/products/construction" },
      { label: "Inventory & Warehousing", href: "/products/inventory" },
      { label: "Logistics & Fleet Dispatch", href: "/products/logistics" },
      { label: "Pickleball & Court OS", href: "/products/pickleball" },
      { label: "Sports Arena & Venues", href: "/products/sports-hub" },
      { label: "Booking & Reservations", href: "/products/booking" },
      { label: "Smart Virtual Queuing", href: "/products/queuing" },
      { label: "RAG Enterprise Knowledge", href: "/products/rag-engine" },
      { label: "Dynamic NFC Smart Card", href: "/products/nfc-card" },
      { label: "White-Label Reseller Option", href: "/products/white-label" },
    ],
  },

  {
    title: "Sectors & Pricing",
    links: [
      ...
      { label: "Cloud vs On-Prem", href: "/#deployment" },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      ...
      { label: "AI Spec Dossier", href: "/llms-full.txt" },
