...
export const solutionPackages = [
  {
    ...
    title: "Core Operational Platform",
    tagline: "For boutique recovery teams and specialized agencies replacing spreadsheets.",
    teamScope: "1 – 15 Agent Seats",
    deployment: "Secure Managed Cloud",
    pricingModel: "Custom Scoped Baseline",
    pricingSubtext: "Assisted migration & floor onboarding included",
    highlights: [
      ...
      "Reusable CSV/Excel Data Mapping",
  ...
  },
  {
    id: "growth",
    tier: "GROWTH",
    badge: "Recommended · Scaling Teams",
    title: "Growth & Automated Scale",
    tagline: "For scaling agencies needing unified telephony, automated PTP, and supervisor QA.",
    teamScope: "16 – 100+ Agent Floor",
    deployment: "High-Availability Cloud + Dedicated SIP",
    pricingModel: "Modular Seat & Minute Volume",
    pricingSubtext: "Volume discounts & priority implementation engineering",
    highlights: [
  ...
  },
  {
    ...
    title: "Enterprise Sovereign Tier",
    tagline: "For commercial banks, financial institutions, and multi-client BPO operations.",
    teamScope: "100+ Seats / Multi-Tenant",
    deployment: "Private VPC or On-Premises Ready",
    pricingModel: "Custom Enterprise Agreement",
    pricingSubtext: "Dedicated Solutions Architect, Custom SLA & Regulatory Audit",
    highlights: [
