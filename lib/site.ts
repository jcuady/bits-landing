...
export const solutionPackages = [
  {
    id: "starter",
    tier: "STARTER",
    badge: "Core Operational Foundation",
    tagline: "For focused agencies and specialized teams replacing disconnected spreadsheets.",
    description:
      "Establish centralized operational control with core CRM, structured account staging, dynamic work queues, and essential floor reporting.",
    highlights: [
      "Core BITScrm Portfolio & Account Engine",
      "Custom Delinquency & Account Dispositions",
      "Dynamic Collector Work Queues",
      "Manual & Preview Dialing Support",
      "Standard Real-Time Floor Dashboards",
      "Role-Based Access & Audit Logging",
      "Standard CSV/Excel Reusable Data Mapping",
  ...
  },
  {
    id: "growth",
    tier: "GROWTH",
    badge: "Most Popular For Scaling Agencies",
    tagline: "For growing operations requiring integrated communications, auto-dialing, and QA.",
    description:
      "Supercharge floor productivity with browser SIP softphones, automated Promise-to-Pay workflows, supervisor live coaching, and AI operational assistance.",
    highlights: [
      "Everything in Starter Tier",
      "Built-in Browser SIP Softphone & Telephony",
      "Progressive & Configurable Dialing Workflows",
      ...
      "BITSagent AI Assistance & Smart Follow-Up",
  ...
  },
  {
    id: "enterprise",
    tier: "ENTERPRISE",
    badge: "Tailored Technology Architecture",
    tagline: "For banks, high-volume BPOs, and organizations with complex security and workflow needs.",
    description:
      "End-to-end bespoke digital infrastructure with dedicated SIP routing, full autonomous AI operations, core banking feeds, and on-prem or sovereign hosting.",
    highlights: [
      "Everything in Growth Tier",
      "Fully Bespoke Workflow & Architecture Development",
      ...
      "Regulatory Audit Scoping (BSP/NPC Principles)",
      "Private VPC or On-Premises Hosting Options",
      "Dedicated Solutions Architect & Custom SLA",
    ],
    primaryCta: "Book an Architecture Consultation",
