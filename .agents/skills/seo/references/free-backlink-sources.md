...
This is enforced, not advisory: `"$HOME/.claude/skills/seo/scripts/claude-seo" run validate_backlink_report.py` fails
...
- **Command:** `"$HOME/.claude/skills/seo/scripts/claude-seo" run moz_api.py`
...
- **Command:** `"$HOME/.claude/skills/seo/scripts/claude-seo" run bing_webmaster.py`
...
- **Command:** `"$HOME/.claude/skills/seo/scripts/claude-seo" run commoncrawl_graph.py`
...
- **Command:** `"$HOME/.claude/skills/seo/scripts/claude-seo" run verify_backlinks.py`
